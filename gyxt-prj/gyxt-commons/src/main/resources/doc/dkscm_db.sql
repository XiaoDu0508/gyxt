...
insert into sys_menu(parent_id, menu_text, menu_url, menu_icon, sort_order, status_code) values(0, '我的采购', '', 'fa fa-calendar', 3, 'ENABLE');
...
insert into sys_menu(parent_id, menu_text, menu_url, menu_icon, sort_order, status_code) values(3, '我的采购', 'purchase/index', 'fa fa-sign-language', 13, 'ENABLE');
...
insert into sys_user(user_no, username, cellphone, password, role_id, id_card, email, status_code) values('DK000001', '王大锤', '12345678901', '21232f297a57a5a743894a0e4a801fc3', 1, '', '', 'ENABLE');
insert into sys_user(user_no, username, cellphone, password, role_id, id_card, email, status_code) values('DK000002', '王二锤', '12345678902', '21232f297a57a5a743894a0e4a801fc3', 2, '', '', 'ENABLE');
insert into sys_user(user_no, username, cellphone, password, role_id, id_card, email, status_code) values('DK000003', '王三锤', '12345678903', '21232f297a57a5a743894a0e4a801fc3', 3, '', '', 'ENABLE');
insert into sys_user(user_no, username, cellphone, password, role_id, id_card, email, status_code) values('DK000004', '王四锤', '12345678904', '21232f297a57a5a743894a0e4a801fc3', 4, '', '', 'ENABLE');
insert into sys_user(user_no, username, cellphone, password, role_id, id_card, email, status_code) values('DK000005', '王五锤', '12345678905', '21232f297a57a5a743894a0e4a801fc3', 5, '', '', 'ENABLE');
